...
import 'package:juna_restaurant/core/app_asset.dart';
import 'package:juna_restaurant/src/model/food_category.dart';
...
class AppData {
  ...
  static List<BottomNavigationItem> bottomNavigationItems = [
    ...
    BottomNavigationItem(
        const Icon(Icons.list_alt_outlined), const Icon(Icons.list_alt), 'Profile')
  ];
